...
function Footer() {
    ...
    return (
        ...
        <footer className={fixSt.foot}>
            ...
            <div className={fixSt.f_link + ` link`} ref={fmenu}>
                <div className={fixSt.column + ` link`}onClick={() => { fnav.push('/pages/myfortune') }}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="34" height="32" viewBox="0 0 34 32" fill="none" className={fixSt.f_svg} >
                ...
                <div className={fixSt.column + ` link`}onClick={() => { fnav.push('/pages/matchlist') }}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="33" height="28" viewBox="0 0 33 28" fill="none" className={fixSt.f_svg}>
                ...
                <div className={fixSt.column + ` link`}onClick={() => { fnav.push('/pages/picklist') }}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="28" viewBox="0 0 40 28" fill="none" className={fixSt.f_svg}>
